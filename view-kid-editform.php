 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editKidModal<?php echo $kid['kid_id'];?>">
        ...
        <!-- Modal -->
<div class="modal fade" id="editKidModal<?php echo $kid['kid_id'];?>" tabindex="-1" aria-labelledby="editKidModal<?php echo $kid['kid_id'];?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editKidModalLabel<?php echo $kid['kid_id'];?>">Edit Kid</h1>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="kidName<?php echo $kid['kid_id'];?>" name="kidName" value="<?php echo $kid['kid_name'];?>">
      </div>
  <div class="mb-3">
